...
CONFIG = {
    ...
    "feeds": {
        "新加坡": [
            ...
            {"url": gnews_url("Singapore economy trade finance technology 2026", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SG Economy"},
            {"url": gnews_url("Singapore MAS regulation fintech crypto", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SG MAS/Fintech"},
        ],
        "越南": [
            {"url": gnews_url("Vietnam export manufacturing FDI trade 2026", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | VN Trade/FDI"},
        ...
        "菲律宾": [
            {"url": gnews_url("Philippines trade export BPO investment manufacturing", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | PH Trade/BPO"},
            {"url": gnews_url("Philippines economy GDP remittance infrastructure", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | PH Economy"},
        ],
        "马来西亚": [
            {"url": "https://www.thestar.com.my/rss/News", "tag": "The Star MY"},
            {"url": gnews_url("Malaysia semiconductor trade investment export penang", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | MY Semi/Trade"},
            {"url": gnews_url("Malaysia economy GDP palm oil oil gas", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | MY Economy"},
        ],
        "柬埔寨+缅甸+老挝": [
            {"url": gnews_url("Cambodia garment manufacturing export tariff GSP", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | KH Garment/GSP"},
            {"url": gnews_url("Myanmar trade sanction investment conflict economy", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | MM Trade/Sanction"},
            {"url": gnews_url("Laos economy debt infrastructure China investment", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | LA Economy/China"},
        ],
        "政治+社会": [
            {"url": gnews_url("Southeast Asia political stability protest election policy change", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SE Asia Politics"},
            {"url": gnews_url("Myanmar conflict military junta ASEAN response", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | Myanmar Crisis"},
            {"url": gnews_url("South China Sea dispute ASEAN Philippines Vietnam patrol", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SCS/ASEAN"},
        ],
        "基础设施+科技": [
            {"url": gnews_url("Southeast Asia infrastructure project port railway energy", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SE Asia Infra"},
            {"url": gnews_url("Southeast Asia technology innovation startup hub Singapore Vietnam", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SE Asia Tech"},
        ],
        "气候+人口": [
            {"url": gnews_url("Southeast Asia climate change drought flood energy crisis", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SE Asia Climate"},
            {"url": gnews_url("Southeast Asia demographic youth population unemployment", hl="en-SG", gl="SG", ceid="SG:en"), "tag": "GNews | SE Asia Demo"},
        ],
        "大国关系": [
        ...
        "专题精选": [
            {"url": gnews_url(topic="WORLD", hl="en-US", gl="SG", ceid="SG:en"), "tag": "GNews Topic | WORLD(SG)"},
        ],
    },
}
